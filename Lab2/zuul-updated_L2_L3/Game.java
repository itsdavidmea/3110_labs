...
public class Game 
{
    ...
    {
        Room outside, theater, pub, lab, office, Telephone_Cab;
        ...
        Telephone_Cab = new Room("in the phone cabbin");
        ...
        pub.setExit(Room.SOUTH, outside);


        lab.setExit(Room.NORTH, outside);
        lab.setExit(Room.SOUTH, office);
